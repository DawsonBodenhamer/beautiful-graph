...
export type WorkerNode={id:string;x:number;y:number;degree:number;radius:number;vx?:number;vy?:number};
...
export type WorkerReadyMessage={type:"ready";version:typeof WORKER_PROTOCOL_VERSION;revision:number};
