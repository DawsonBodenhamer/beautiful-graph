export type PanelAnchor="top-left"|"bottom-left"|"bottom-right";

export function panelAnchor(id:string):PanelAnchor {
  return id==="groups"?"top-left":id==="forces"?"bottom-left":"bottom-right";
}
...
export function resolvePanelPosition(id:string,pinned:boolean,stateX:number,stateY:number,hostWidth:number,hostHeight:number,panelWidth:number,panelHeight:number):{x:number;y:number} {
  ...
  if(pinned)return{
    x:anchor==="bottom-right"?hostWidth-panelWidth-marginX:marginX,
    y:anchor==="top-left"?marginY:hostHeight-panelHeight-marginY
  };
  return{
