...
export default class BeautifulGraphPlugin extends Plugin {
  ...
  async persistData():Promise<void>{this.data.settings=this.settings;await this.saveData(this.data)}
  ...
  registerGraph(view:BeautifulGraphView):void{this.lastGraph=view}
