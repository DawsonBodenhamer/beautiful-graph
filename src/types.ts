export interface GraphForces { center: number; repel: number; link: number; distance: number; curvature: number; stretchiness: number; siblingLinkForce: boolean }
...
export interface PanelState { visible:boolean; collapsed:boolean; x?:number; y?:number; width?:number; height?:number; z?:number; legacyPixels?:PanelPixelGeometry }
